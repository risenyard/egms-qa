...
def build_parser() -> argparse.ArgumentParser:
    ...
    ref.add_argument("--manifest", required=True,
                     help="Full European candidate-pool manifest for optional threshold estimation. "
                          "The candidate pool is not included in the Dataset. This subcommand "
                          "writes a reference JSON; final uses the fixed 4.8 mm/yr threshold by default.")
    ...
    final.add_argument("--reference-json", default=None,
                       help="Optional threshold JSON generated by the reference subcommand. "
                            "Defaults to the fixed 4.8 mm/yr threshold when omitted.")
