...
directory without editing source.
  ...
  EGMS_ENCODER_HOME  the EGMS ground-motion encoder project, for raw tile access
...
# The separate EGMS encoder project, needed only to (re)compute task reference
# values from the raw 10k tile store. Not required to train/evaluate from the
